# nvim-treesitter-queries-ebnf

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-ebnf/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-ebnf/actions/workflows/validate.yml)

Neovim tree-sitter queries for **ebnf**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-ebnf",
...
- [ ] Changes are scoped to `ebnf` — do not include files for other languages
